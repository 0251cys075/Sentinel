export interface Database {
  public: {
    Tables: {
      ...
      trip_locations: {
        Row: { id: string; trip_id: string; lat: number; lng: number; recorded_at: string };
        Insert: { id?: string; trip_id: string; lat: number; lng: number; recorded_at?: string };
        Update: { id?: string; trip_id?: string; lat?: number; lng?: number; recorded_at?: string };
      };
      alerts: {
